...
public class CandidateCvManager implements CandidateCvService {
	...
	@Autowired
	public CandidateCvManager(CandidateCvDao candidateCvDao, CandidateSchoolDao candidateSchoolDao, CandidateTalentDao candidateTalentDao, CandidateLanguageDao candidateLanguageDao, CandidateJobExperienceDao candidateJobExperienceDao, ImageService imageService) {
	...
	public DataResult<List<CandidateCv>> getAll() {
		return new SuccessDataResult<List<CandidateCv>>(this.candidateCvDao.findAll(),"Job Seeker's CVs are listed!");
	}
	...
	public Result add(CandidateCv candidateCv) {
		...
		System.out.println("Schools : " + candidateCv.getSchools().size());
		System.out.println("Languages : " + candidateCv.getLanguages().size());
		System.out.println("Talents : " + candidateCv.getTalents().size());
		System.out.println("Experience : " + candidateCv.getJobExperience().size());
		
		
		
		
		return new SuccessResult("Job Seeker's CV added!");
	}
